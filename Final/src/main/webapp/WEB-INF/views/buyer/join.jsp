...
<form action="/buyer/join" method="post" onsubmit="return joinConfirm()">

	아이디 : <input class="form control" type="text" name="buyerId" id="buyerId"><input class="btn" type="button" name="idUse" id="idUse" value="중복확인"> 
	<br><br>
	<input type="hidden" value="" id="idConfirm">
	<div id="okId"></div>
	비밀번호 : <input class="form control" type="password" name="buyerPw" id="buyerPw"> 
	<br><br>
	<div id="pwTest"></div>
	비밀번호확인 : <input class="form control" type="password" name="pwConfirm" id="pwConfirm">
	<br><br>
	<div id="okPw"></div>
	이름 : <input class="form control" type="text" name="buyerName" id="buyerName">
	<br><br>
	email : <input class="form control" type="email" name="buyerEmail" id="buyerEmail">
	<input class="btn"type="button" value="인증코드발송" id="okemail"> 
	<br><br>
	<div id="isItEmail"></div>
	인증코드 입력<input class="form control" type="text" name="emailCode" id="emailCode"> <!-- 메일로 받은 인증코드를 입력하는 값  -->
	...
	핸드폰 번호 : <input class="form control" type="text" name="buyerPhone" id="buyerPhone">
	<br><br>
	<input class="btn btn-primary" type="submit" name="join" id="join" value="가입">
	<a href="/buyer/login"><button class="btn btn-danger"type="button">취소</button></a>
</form>
